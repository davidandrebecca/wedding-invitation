...
function setupEventListeners() {
    ...
    window.addEventListener('popstate', () => {
        const pageName = window.location.hash.substring(1) || 'cover';
...
async function initApp() {
    try {
        ...
        // Load the initial page based on the URL hash, default to 'cover' if no hash
        const initialPage = window.location.hash.substring(1) || 'cover';
